...
validate_User_Input 		     PROTO userInput_:DWORD, instanceType_:BYTE
...
main proc
	...
	.code
		...
		Choice: mov eax, Cyan
					   ...
					   call ReadDec
							mov userInput1, eax
							INVOKE validate_User_Input, userInput1, 1	
							cmp dl, 1							
								je Choice
							cmp dl, 2							
								je exitProgram
			...
			Game: call Clrscr								 
				  ...
				  user_selections: mov eax, white
								   ...
								   call ReadDec								
									  ...
									  INVOKE validate_User_Input, user_selection21, 3
										  cmp dl, 1
											  je Game
				  ...
				  user_selection221 : mov eax, white
								   ...
								   call ReadDec								
								      ...
								      INVOKE validate_User_Input, user_selection22, 3
										  cmp dl, 1
											  je Game
			...
			Game: call Clrscr								 
				  ...
				  user_selections: mov eax, white
								   ...
								   call ReadDec								
									  ...
									  INVOKE validate_User_Input, user_selection, 3
										  cmp dl, 1
											  je Game
...
Start_CvC_Game PROC
	...
	ret
Start_CvC_Game ENDP
validate_User_Input PROC x1:DWORD, y1:BYTE	
		.data
			...
			overflow_prompt        BYTE        "that number exceeds 32-bits,Please try agian. ", 0
		...
		.code
			...
			doneChecking: cmp user_input1, 5	
							je setExitCode
						mov failCheck, 0
						jmp leaveProc1
